...
def main():
    ...
    units = per_unit*3
    symbol = net1(units=units, num_stage=3, filter_list=filter_list, num_class=args.num_classes,
    ...
    if not os.path.exists("./model"):
        os.mkdir("./model")
    model_prefix = "model/net1-{}-{}-{}".format(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="command for training net1")
