...
def main():
    ...
    if not os.path.exists("./model"):
        os.mkdir("./model")
    model_prefix = "model/densenet-{}-{}-{}".format(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="command for training densenet")
    ...
    parser.add_argument('--growth-rate', type=int, default=12,
                        help='the growth rate of DenseNet')
    ...
    parser.add_argument('--reduction', type=float, default=0.5,
                        help='the compression ratio for TransitionBlock')
