...
def main():
    ...
    units = per_unit*3
    symbol = net4(units=units, num_stage=3, filter_list=filter_list, num_class=args.num_classes,
    ...
    if not os.path.exists("./model"):
        os.mkdir("./model")
    model_prefix = "model/net4-{}-{}-{}".format(
    ...
    model.fit(
        ...
        optimizer_params    = (('learning_rate', args.lr), ('momentum', args.mom), ('wd', args.wd), (
            'lr_scheduler', multi_factor_scheduler(begin_epoch, epoch_size, step=[60], factor=0.1))),
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="command for training net4")
